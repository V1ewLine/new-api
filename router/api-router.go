...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login", middleware.DisableCache(), anonymousRequestBodyLimit, middleware.LoginRateLimit(), middleware.TurnstileCheck(), controller.Login)
		...
		logRoute.GET("/self/export", middleware.UserAuth(), middleware.SearchRateLimit(), controller.ExportSelfLogs)
		...
		dataRoute.GET("/models", middleware.AdminAuth(), controller.GetModelAnalyticsExportOptions)
		dataRoute.GET("/self/models", middleware.UserAuth(), controller.GetSelfModelAnalyticsExportOptions)
		dataRoute.GET("/export", middleware.AdminAuth(), controller.ExportModelAnalytics)
		dataRoute.GET("/self/export", middleware.UserAuth(), controller.ExportSelfModelAnalytics)
		...
		clusterRoute.Use(middleware.AdminAuth())
		{
			...
			clusterRoute.GET("/export/history", controller.ExportClusterTelemetryHistory)
			clusterRoute.GET("/telemetry/trends", controller.GetClusterAggregateTelemetryTrends)
			clusterRoute.POST("/", controller.CreateCluster)
			clusterRoute.GET("/models/:modelId", controller.GetClusterModelDetail)
			clusterRoute.GET("/models/:modelId/telemetry/trends", controller.GetClusterModelTelemetryTrends)
