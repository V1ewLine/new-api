...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/responses-capabilities", permission: authz.ChannelRead, handler: controller.GetChannelResponsesCapabilities},
	{method: http.MethodPost, path: "/:id/responses-capabilities/detect", permission: authz.ChannelOperate, handler: controller.DetectChannelResponsesCapabilities},
