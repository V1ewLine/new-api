...
func TestClusterMutationRoutesRequireAdminAuthentication(t *testing.T) {
	...
	testCases := []struct {
		...
		{method: http.MethodGet, path: "/api/clusters/telemetry/trends?start_at=2026-07-25T00:00:00Z&end_at=2026-07-25T01:00:00Z", route: "/api/clusters/telemetry/trends"},
		{method: http.MethodGet, path: "/api/clusters/models/1/telemetry/trends?start_at=2026-07-25T00:00:00Z&end_at=2026-07-25T01:00:00Z", route: "/api/clusters/models/:modelId/telemetry/trends"},
